...
surface(t, x, u, title="Dependency of the speed on time and spatial coordinate", xaxis="t", yaxis="x", zaxis="u(x,t)", camera = (90, 25))
savefig("images/julia-tests/figure1.png")
...
savefig("images/julia-tests/figure2.png")
...
savefig("images/julia-tests/figure3.png")

plot(x, u[:, 1], lw = 5, title="Dependency of the speed on the spatial coordinate", xaxis="x", yaxis="u(x)", label="Initial time moment", legend=:topleft)
plot!(x, u[:, Nt+1], lw = 5, title="Dependency of the speed on the spatial coordinate", xaxis="x", yaxis="u(x)", label="Final time moment")
savefig("images/julia-tests/figure4.png")